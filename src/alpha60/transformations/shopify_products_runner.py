"""Composition root for Shopify products staging transformation."""
...
def run_shopify_products_staging_transformation(
    settings: Settings,
    staging_dataset_id: str | None = None,
) -> TransformationResult:
    """Run the Shopify products staging transformation using runtime settings."""
