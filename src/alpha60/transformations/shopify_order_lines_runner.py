"""Composition root for Shopify order lines staging transformation."""
...
def run_shopify_order_lines_staging_transformation(
    settings: Settings,
    staging_dataset_id: str | None = None,
) -> TransformationResult:
    """Run the Shopify order lines staging transformation using runtime settings."""
