"""Shopify order staging transformation factory."""
...
def create_shopify_orders_staging_transformation(
    client: QueryClient,
    raw_config: BigQueryConfig,
    staging_dataset_id: str,
) -> SqlTransformationRunner:
    """Create the Shopify orders staging transformation."""
    target_table_id = f"{raw_config.project_id}.{staging_dataset_id}.shopify_orders"
