"""Composition root for Shopify locations staging transformation."""

from alpha60.config.settings import Settings
from alpha60.transformations.result import TransformationResult
from alpha60.transformations.shopify_locations import (
    create_shopify_locations_staging_transformation,
)
...
def run_shopify_locations_staging_transformation(
    settings: Settings,
    staging_dataset_id: str | None = None,
) -> TransformationResult:
    """Run the Shopify locations staging transformation using runtime settings."""
    ...
    transformation = create_shopify_locations_staging_transformation(
        client=client,
