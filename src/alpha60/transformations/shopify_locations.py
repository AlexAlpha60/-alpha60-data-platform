"""Shopify locations staging transformation factory."""
...
_SQL_PATH = Path(__file__).parent / "sql" / "shopify" / "stg_shopify_locations.sql"


def create_shopify_locations_staging_transformation(
    client: QueryClient,
    raw_config: BigQueryConfig,
    staging_dataset_id: str,
) -> SqlTransformationRunner:
    """Create the Shopify locations staging transformation."""
    target_table_id = f"{raw_config.project_id}.{staging_dataset_id}.shopify_locations"
