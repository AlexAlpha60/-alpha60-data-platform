"""Tests for Shopify products staging transformation composition."""
...
def test_run_shopify_products_staging_transformation_wires_dependencies() -> None:
    ...
    with (
        patch(
            "alpha60.transformations.shopify_products_runner.create_bigquery_client"
        ) as client_factory,
        patch(
            "alpha60.transformations.shopify_products_runner."
        ...
        result = run_shopify_products_staging_transformation(settings=_settings())
